...
class LogicBoxData:
    def __init__(self, player_object):
        ...
        self.trophy_road_brawlers_item_names = [
            "colt", "bull", "nita", "jessie", "dynamike", "brock", "poco", "tick", "8bit", "emz", "bo"
        ]
    ...
    def randomize(self, box_type):
        ...
        for i, brawler_row in enumerate(data_rows_for_loop):
            if len(brawler_row) > max(self.NAME_COL_INDEX, self.ITEM_NAME_COL_INDEX, self.HERO_TYPE_COL_INDEX):
                brawler_item_name = brawler_row[self.ITEM_NAME_COL_INDEX]
            ...
            if (random.randint(0,100) < 100):
                ...
                for resource in self.player.resources:
                    if resource['ID'] == 8: 
                        ...
                        self.player.db.update_player_account(self.player.token, 'Gold', resource['Amount'])
                        break
                ...
                for x in range(num_pp_rewards):
                    ...
                    if available_brawlers_for_pp:
                        ...
                        if (self.player.brawlers_level.get(str(brawler_id_for_pp), 0) < 8):
                            ...
                            self.player.brawlers_powerpoints[str(brawler_id_for_pp)] = self.player.brawlers_powerpoints.get(str(brawler_id_for_pp), 0) + pp_value
            ...
            if (random.randint(0,100) < 100):
                if locked_brawlers_pool_item_names:
                    ...
                    if brawler_id is not None:
                        ...
                        print(f"ERROR: Small Box - Could not find canonical ID for brawler ItemName: {chosen_brawler_item_name}")
                ...
                if (bonus == 8): 
                    ...
                    for resource in self.player.resources:
                        if resource['ID'] == 2: 
                            ...
                            self.player.db.update_player_account(self.player.token, 'Tokens', resource['Amount'])
                            found_tokens_resource = True
                            break
                    if not found_tokens_resource:
                        print(f"ERROR: Small Box - Could not find resource with ID 2 for Token Doublers in player.resources. Cannot update tokens.")
            ...
            if (random.randint(0,100) < 100):
                if locked_brawlers_pool_item_names: 
                    ...
                    if brawler_id is not None:
                        ...
                        print(f"ERROR: Big Box - Could not find canonical ID for brawler ItemName: {chosen_brawler_item_name}")
                ...
                if (bonus == 8): 
                    ...
                    for resource in self.player.resources:
                        if resource['ID'] == 2: 
                            ...
                            break
                    if not found_tokens_resource:
                        print(f"ERROR: Big Box - Could not find resource with ID 2 for Token Doublers in player.resources. Cannot update tokens.")
            ...
            if (random.randint(0,100) < 100):
                if locked_brawlers_pool_item_names: 
                    ...
                    if brawler_id is not None:
                        ...
                        print(f"ERROR: Mega Box - Could not find canonical ID for brawler ItemName: {chosen_brawler_item_name}")
                ...
                if (bonus == 8): 
                    ...
                    for resource in self.player.resources:
                        if resource['ID'] == 2: 
                            ...
                            break
                    if not found_tokens_resource:
                        print(f"ERROR: Mega Box - Could not find resource with ID 2 for Token Doublers in player.resources. Cannot update tokens.")
